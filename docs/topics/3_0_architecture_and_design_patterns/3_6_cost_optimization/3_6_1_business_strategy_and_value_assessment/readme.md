...
<div style="margin:auto;text-align:center;width:100%;"><img src="./assets/Picture11.png" alt="Graphic Displaying the flow of covering custom vision->identify use cases->determine business value->Estimate ROI" width="800"/></div>
